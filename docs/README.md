...
#### 採用（2023/02 ~ 現在）
#### エコオク-PM（2023/10 ~ 現在）
#### プレミア-GATCH（2024/02 ~ 2024/03）
#### エコオク-Member（2023/07 ~ 2023/09）
#### Anchor-PM（2023/07 ~ 2024/01）
#### プレミア-車検（2023/03 ~ 2023/04）
#### CRAVE（2023/02 ~ 2023/08）
#### Anchor-Member（2023/02 ~ 2023/06）
...
#### BNPLサービスのシステム新規開発、追加開発（2022/04 ~ 2023/01）
...
#### BNPLサービスのシステム新規開発、追加開発（2019/10 ~ 2022/3）
...
* エンジニアとしての基礎学習
    * Webサイト構築の基礎（HTML、CSS、JavaScript、jQuery）
    * データベース演習
    * バージョン管理システム概論（Git、Github）
    * Java演習（基礎構文、オブジェクト指向、フレームワーク、MVCモデル）
    * 個人ECサイト構築プロジェクト演習
    * チームECサイト構築プロジェクト演習
